...
public class WeaponManager : MonoBehaviour
{
    ...
    [Header("Lethals")]
    public int maxLethals = 30;
    public int lethalsCount = 0;
    public Throwable.ThrowableType equippedLethalType;
    public GameObject grenadePrefab;

    [Header("Tacticals")]
    public int maxTacticals = 30;
    ...
    {
        GameObject lethatPrefab = GetThrowablePrefab(equippedLethalType);
        GameObject throwable = Instantiate(lethatPrefab, throwableSpawn.transform.position, Camera.main.transform.rotation);
